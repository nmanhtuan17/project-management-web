...
export function Mail(props: MailProps) {
  ...
  const emailLabel = {
    ...
    [EmailLabel.DRAFTS]: "Drafts",
    [EmailLabel.IMPORTANT]: "Important",
          ...
          <Nav
            ...
            links={[
              ...
              },
              {
                ...
                label: "",
                icon: Star,
                variant: pathname.includes('important') ? 'default' : 'ghost',
              ...
              },
              {
                ...
                label: "",
                icon: File,
                variant: pathname.includes('drafts') ? 'default' : 'ghost',
                path: `/mails/drafts`
              },
              {
                title: "Trash",
        ...
        <ResizablePanel defaultSize={defaultLayout[1]} minSize={30}>
          <Tabs defaultValue="all" className={'w-full h-full flex flex-col min-h-full'}>
            ...
            <TabsContent value="unread" className="m-0 flex-1 overflow-y-auto">
              <div className={'flex flex-col flex-1 h-full'}>
                <MailList items={emails.filter((item) => !item.seen)}/>
              </div>
            </TabsContent>
          </Tabs>
        </ResizablePanel>
